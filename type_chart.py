...
def dual_effectiveness(attacking_type, defending_type1, defending_type2=None):
    multiplier1 = get_effectiveness(attacking_type, defending_type1)
    if defending_type2 is None:
        return multiplier1
    multiplier2 = get_effectiveness(attacking_type, defending_type2)
